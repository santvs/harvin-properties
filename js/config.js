...
const USER_TYPES = {
  tenant: {
    ...
    registerFields: [
      ...
      { id: "currentAddress", type: "text", label: "Current Address", placeholder: "123 Main St", required: false },
      { id: "city", type: "text", label: "City", placeholder: "e.g. Seattle", required: false },
      { id: "state", type: "text", label: "State", placeholder: "e.g. WA", required: false },
      { id: "zipcode", type: "text", label: "Zip Code", placeholder: "e.g. 98038", required: false },
...
const FOOTER_CONFIG = {
  columns: [
    {
      title: "Buy & Sell",
      links: ["Buy a Home", "Sell a Home", "Free Home Valuation", "Mortgage Referrals", "Offer & Contract Support"],
    },
    {
      title: "For Tenants",
      links: ["Find a Home", "Apply Online", "Pay Rent Online", "Maintenance Requests", "Lease Management"],
    },
    {
      title: "For Landlords & Managers",
      links: ["List a Property", "Tenant Screening", "Rent Collection", "Financial Reports", "Property Manager Guide"],
    },
    {
      title: "Company",
      links: ["About Us", "Our Team", "Features", "Contact Us", "Admin Login"],
    },
  ],
  social: [
